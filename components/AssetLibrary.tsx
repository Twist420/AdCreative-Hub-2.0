...
import { DetailRow, MetricBox } from './asset-library/AssetMetricParts';
import { CreateLibraryModal } from './asset-library/CreateLibraryModal';
import {
  ...
  parseDuration,
  removeNodeAtPath,
  updateNodeDetailsAtPath,
  type AssetFacet,
  type AssetFacetCategory,
  type FolderNode,
  ...
  return (
    <div className="relative flex h-full overflow-hidden bg-white">
      ...
      {selectedDetailItem && (
       ...
       <CreateLibraryModal
        isLibModalOpen={isLibModalOpen}
        setIsLibModalOpen={setIsLibModalOpen}
        libSystem={libSystem}
        setLibSystem={setLibSystem}
        libParentPath={libParentPath}
        setLibParentPath={setLibParentPath}
        libName={libName}
        setLibName={setLibName}
        libSelectedAssets={libSelectedAssets}
        setLibSelectedAssets={setLibSelectedAssets}
