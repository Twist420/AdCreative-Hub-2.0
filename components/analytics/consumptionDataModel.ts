...
export const platforms: MaterialSpend['platform'][] = ['Android', 'iOS'];
export const languages: MaterialSpend['language'][] = ['EN', 'JA', 'KO', 'DE'];

export const buildMockSpends = (): MaterialSpend[] => {
...
export const getTypeLabel = (type: MaterialType) => ({ video: '视频', playable: '试玩', image: '图片' }[type]);

export const getSortValue = (row: MaterialSpend, key: string, totalSpend: number) => {
